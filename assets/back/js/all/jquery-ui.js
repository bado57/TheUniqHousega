...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNamesShort: ["Ock", "Şbt", "Mar", "Nis", "May", "Haz", "Tem", "Ags", "Eyl", "Ekm", "Kas", "Arl"], // For formatting
		dayNames: ["Pazar", "Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi"], // For formatting
		dayNamesShort: ["Pzr", "Pts", "Sal", "Çar", "Per", "Cum", "Cmt"], // For formatting
		dayNamesMin: ["P","Pt","S","Ç","Pr","Cm","Ct"], // Column headings for days starting at Sunday
