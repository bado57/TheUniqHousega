<script src="<?php echo SITE_BACK_CJS; ?>/designform.js" type="text/javascript"></script>
<style type="text/css">
    .hidden-first {
        display: none;
    }
                            ...
                            <input name="duzenleme" type="hidden" value="" >
                                <input name="duzenlemeID" type="hidden" value="" >
                                    ...
                                    <div class="box box-info">
                                        <div class="box-header with-border">
                                            <h3 class="box-title">Design Form İçerik</h3>
                                        </div>
                                        <div class="box-body">
                                                ...
                                                <tbody class="" id="tbody">
                                                    <?php foreach ($model[0] as $kModel) { ?>
                                                        <tr id="<?php echo $kModel['ID']; ?>">
                                                            ...
                                                            <td class="hidden-xs"><?php echo $kModel['State']; ?></td>
